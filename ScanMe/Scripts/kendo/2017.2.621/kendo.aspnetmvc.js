        ...
        extend(true, kendo.data, {
            transports: {
                'aspnetmvc-server': kendo.data.RemoteTransport.extend({
                    ...
                    read: function(options) {
                        var url, prefix = this.options.prefix,
                            params = [
                                prefix + 'sort',
                                prefix + 'page',
                                prefix + 'pageSize',
    ...
    (function($, undefined) {
        ...
        if (ui && ui.MultiSelect) {
            ui.MultiSelect.requestData = function(selector) {
                ...
                return {
                    text: text !== multiselect.options.placeholder ? text : ''
                };
            };
        }
    }(window.kendo.jQuery));
...
(function(f, define) {
    ...
    (function($, undefined) {
        ...
        function rulesFromData(metadata) {
            var idx, length, fields = metadata.Fields || [],
                rules = {};
        ...
        function rulesForField(field) {
            var rules = {},
                ...
                validationType, validationParams, idx, length;
